...
<<<<<<< HEAD
                        ...
                        <tr>
                            <td colspan="2" id="cost_item_<?php echo e($row->cost_item); ?>"><?php echo e($row->cost_item); ?></td>
=======
...
>>>>>>> a0eb8bb19d210f70346d440c9db605f8660f39c1
                            ...
                            <td contentEditable="true" class="edit" id="total_budget_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('total_budget','<?php echo e($row->cost_item); ?>')"><?php echo e($row->total_budget); ?></td>
                            <td contentEditable="true" class="edit" id="q1_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q1','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q1); ?></td>
                            <td contentEditable="true" class="edit" id="q2_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q2','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q2); ?></td>
                            <td contentEditable="true" class="edit" id="q3_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q3','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q3); ?></td>
                            <td contentEditable="true" class="edit" id="q4_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q4','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q4); ?></td>
                            <td contentEditable="true" class="edit" id="q5_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q5','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q5); ?></td>
                            <td contentEditable="true" class="edit" id="q6_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q6','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q6); ?></td>
                            <td contentEditable="true" class="edit" id="q7_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q7','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q7); ?></td>
                            <td contentEditable="true" class="edit" id="q8_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q8','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q8); ?></td>
                            <td contentEditable="true" class="edit" id="q9_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q9','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q9); ?></td>
                            <td contentEditable="true" class="edit" id="q10_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q10','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q10); ?></td>
                            <td contentEditable="true" class="edit" id="q11_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q11','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q11); ?></td>
                            <td contentEditable="true" class="edit" id="q12_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('q12','<?php echo e($row->cost_item); ?>')"><?php echo e($row->q12); ?></td>
                            ...
                            <td contentEditable="true" class="edit" id="y1_budget_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('y1_budget','<?php echo e($row->cost_item); ?>')"><?php echo e($row->y1_budget); ?></td>
                            ...
                            <td contentEditable="true" class="edit" id="y2_budget_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('y2_budget','<?php echo e($row->cost_item); ?>')"><?php echo e($row->y2_budget); ?></td>
                            ...
                            <td contentEditable="true" class="edit" id="y3_budget_<?php echo e($row->cost_item); ?>" data-name="price" oninput="totalValue('y3_budget','<?php echo e($row->cost_item); ?>')"><?php echo e($row->y3_budget); ?></td>
