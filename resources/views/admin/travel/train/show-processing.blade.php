            ...
            <div class="">
                ...
                @foreach($order->childRows as $item)
                    ...
                    <div class="col-md-12 text-right">
                        <hr>
                            <button type="button" onclick="completeOrder();" class="btn btn-primary complete-btn">Complete</button>
                    </div>
        ...
        function upload(input) {
            ...
            $.ajax({
                ...
                complete: function(data){
                    $(input).closest('td').html('<i onclick="removeFile();" class="fa fa-times text-danger pull-right p-1"></i><i onclick="window.open(\'/key-travel/{{ $order->order_id }}/'+data.file+'/file\')" class="fa fa-file-pdf attached"></i>')
