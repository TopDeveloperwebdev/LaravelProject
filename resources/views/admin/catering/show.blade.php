            ...
            <div class="row m-b-60">
                        ...
                        <small>
                            <table class="table table-bordered table-small">
                                ...
                                <tr>
                                    ...
                                    <tr><td width="30%">Order Request Date</td><td>{{ $order->created_at->format('d/m/y') }}</td></tr>
                                    <tr><td>Order Submit Date</td><td>{{ $order->created_at->format('d/m/y') }}</td></tr>
                                    <tr><td>Admin</td><td>{{ $order->admin->name ?? '-' }}</td></tr>
                ...
                <form class="form">
                    ...
                    <div class="col-md-12 text-right">
                        <hr>
                            <button type="button" onclick="complete();" class="btn btn-primary">Quote Requested</button>
                    </div>
                </form>
            </div>
        </div>
...
@section('js')
    <script>
        ...
        function complete(){
            ...
            $.get("/catering/{{ $order->order_id }}/processing",data,function(response){
                Swal.close();
                if(response.success){
                    Swal.fire(
                        'Success',
