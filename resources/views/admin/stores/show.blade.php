            ...
            <div class="">
                ...
                <br><br>
                    <table class="table table-data2 orders-table">
                        ...
                        @foreach($order as $items)
                            @foreach($items as $item)
                                <tr id="{{ $item->id }}">
                                    ...
                                    <td width="25%"><input value="{{ $item->description }}" class="form-control" /></td>
                                    <td width="25%"><input value="{{ $item->qty }}" class="form-control" /></td>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9" class=""><button onclick="submitOrder();" class="float-right btn btn-primary submit">Approve Order</button></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
