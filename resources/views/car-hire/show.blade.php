                ...
                <form class="form">
                    <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input disabled value="{{ $order->per_day }}" name="per_day" class="form-control totals" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input disabled value="{{ $order->days }}" name="days" class="form-control totals" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input disabled value="{{ $order->fees }}" name="fees" class="form-control totals" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input disabled value="{{ $order->other }}" name="other" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input disabled value="{{ $order->total }}" name="total" class="form-control" />
                            </div>
                        </div>
...
@section('js')
    <script>
        ...
        function submitOrder(){
            ...
            $.get("/car-hire/{{ $order->order_id }}/processing",data,function(response){
                Swal.close();
                if(response.success){
                    Swal.fire(
                        'Success',
