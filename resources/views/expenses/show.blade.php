                ...
                <form class="form">
                    <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input value="{{ $order->travel_uk }}" name="travel_uk" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input value="{{ $order->subsistence_uk }}" name="subsistence_uk" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input value="{{ $order->travel_overseas }}" name="travel_overseas" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input value="{{ $order->subsistence_overseas }}" name="subsistence_overseas" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input value="{{ $order->total }}" name="total" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input disabled value="{{ $order->currency }}" name="currency" class="form-control" />
                            </div>
                        </div>
