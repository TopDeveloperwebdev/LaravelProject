                            ...
                            <tbody>
                                @foreach($noneCatProcessing as $order)
                                    ...
                                    <tr onclick="window.location='/none-catalogue/{{ $item->order_id }}'" data-url="/none-catalogue/{{ $item->order_id }}/{{ $item->id }}">
                                        ...
                                        <td>
                                        @if($order[0]->file)
                                            <i onclick="event.cancelBubble=true;window.open('/none-catalogue/{{ $order[0]->order_id }}/{{ $order[0]->id }}/file')" class="fa fa-file-pdf attached" />
                                        @else
                                            -
                                        @endif
                                        </td>
