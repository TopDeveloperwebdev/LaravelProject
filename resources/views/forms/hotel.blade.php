                ...
                <h3 class="title-5 m-b-20">Hotel</h3>
                    ...
                    <form class="form">
                        ...
                        <div class="form-group row">
                            <div class="col-md-3">
                                <label class="control-label">Location<span class="ast">*</span></label>
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            <div class="col-md-3">
                                <label class="control-label">Check in Date<span class="ast">*</span></label>
                            </div>
                            <div class="col-md-8">
                                <input name="checkin_date" type="date"  class="form-control required" />
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-3">
                                <label class="control-label">Check out Date<span class="ast">*</span></label>
                            </div>
                            <div class="col-md-8">
                                <input name="checkout_date" type="date" class="form-control required" />
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-3">
                                <label class="control-label">No. of Occupants<span class="ast">*</span></label>
                            </div>
                            <div class="col-md-8">
                                <input name="persons" type="number" class="form-control required" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input name="traveller_name" class="form-control " />
                            </div>
                        </div>
                        <hr />
                        <div class="form-group row">
...
@section('js')
    <script>
        ...
        function submitOrder(){
            ...
            $.post("{{ route('key-travel.hotel.store') }}",$('.form').serialize(),function(response){
                Swal.close();
                if(response.success){
                    Swal.fire(
                        'Success',
