        ...
        <div class="col-md-12">
            <div class="col-md-10">
                ...
                <form class="form">
                    ...
                    <div class="form-group row">
                        <div class="col-md-3">
                            <label class="control-label">London Travel Card </label>
                        </div>
                        <div class="col-md-8">
                            <input type="checkbox" name="ltc_14" style="margin-top: 12px;"/>&nbsp;&nbsp;&nbsp;(Zones 1-4)
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="checkbox" name="ltc_16" style="margin-top: 12px;"/>&nbsp;&nbsp;&nbsp;(Zones 1-6)
                        </div>
                    </div>
                    <hr />
                    <div class="form-group row">
    ...
    <script>
        function addRow(){
            ...
            '<tr>'+
                ...
                '<td ><input type="date" class="form-control" /></td>'+
                '<td ><input type="time" class="form-control" /></td>'+
                '<td><select><option value="0">No</option><option value="1">Yes</option></select></td>'+
        ...
        function submitOrder(){
            ...
            $.post("{{ route('key-travel.train.store') }}",$('.form').serialize(),function(response){
                Swal.close();
                if(response.success){
                    Swal.fire(
                        'Success',
