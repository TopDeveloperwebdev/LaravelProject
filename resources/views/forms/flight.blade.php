            ...
            <div class="col-md-10">
                ...
                <form class="form">
                    ...
                    <div class="form-group row">
                        <div class="col-md-3">
                            <label class="control-label">From<span class="ast">*</span></label>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="form-group row">
                        <div class="col-md-3">
                            <label class="control-label">To<span class="ast">*</span></label>
                        </div>
                        <div class="col-md-8">
...
@section('js')
    <script>
        ...
        function submitOrder(){
            ...
            $.post("{{ route('key-travel.flight.store') }}",$('.form').serialize(),function(response){
                Swal.close();
                if(response.success){
                    Swal.fire(
                        'Success',
